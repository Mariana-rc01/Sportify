...
public class RoadRunning extends ActivityDistanceAltitude{
    ...
    */
    public RoadRunning(int code, String description, int time, int averageHeartRate, LocalDate date, double distance, double altitude, User user){
