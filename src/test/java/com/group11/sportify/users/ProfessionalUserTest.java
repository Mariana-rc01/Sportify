...
public class ProfessionalUserTest {
    ...
    @Test
    public void testProfessionalConstructor(){
        User user1 = new Professional();
    ...
    public void testSetCode(){
        User user1 = new Professional(1, "Liliana","Rua 123", "Liliana23@gmail.com",80,56,160);
        assertEquals(1, user1.getCode());
        user1.setCode(10);
    ...
    public void testGetName(){
        ...
        user1 = new Professional(1, "Liliana","Rua 123", "Liliana23@gmail.com",80,56,160);
        assertEquals("Liliana", user1.getName());
    }
    ...
    public void testGetEmail(){
        ...
        user1 = new Professional(1, "Liliana","Rua 123", "Liliana23@gmail.com",80,56,160);
        assertEquals("Liliana23@gmail.com", user1.getEmail());
    }
    ...
    public void testSetEmail(){
        User user1 = new Professional(1, "Liliana","Rua 123", "Liliana23@gmail.com",80,56,160);
        assertEquals("Liliana23@gmail.com", user1.getEmail());
        user1.setEmail("Liliana23@gmail.pt");
        assertEquals("Liliana23@gmail.pt", user1.getEmail());
    }
    ...
    public void testCalculateCaloriesFactor(){
        User user1 = new Professional(1, "Leonor","Rua 123", "leonor23@gmail.com",80,56,160);
        double factor = 1.4;
